  ...
  var steps = [
    ...
    },
    {
      ...
      content: [
        ...
        '<p><b>Q: 连接失败显示"余额不足"（HTTP 402）？</b><br>A: 免费额度已用完或账户余额不够。解决方法：① 登录对应平台充值（通常 10 块钱能用很久）；② 或者换个供应商注册新号，每个平台都有免费额度。</p>',
        '<p><b>Q: 连接失败显示"API Key 无效"（HTTP 401）？</b><br>A: Key 输入错误或已过期。请重新复制粘贴，注意不要有前后空格。如果仍然失败，去平台重新生成一个新的 Key。</p>',
