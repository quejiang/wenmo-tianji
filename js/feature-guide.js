  ...
  },
  {
    ...
    content: [
      ...
      { subtitle: '如何让 AI 学习书籍？',
        text: '<b>方式一：内置知识库（预加载 392 篇倪海厦典籍）</b><br>'
          + '• 打开 AI 面板后，知识库自动后台加载（约 65MB 分 9 个分片）<br>'
          + '• 加载完成后即可直接搜索提问，无需手动上传<br>'
          + '• 首次加载需网络，后续由 PWA 离线缓存<br><br>'
          + '<b>方式二：上传自己的文档</b><br>'
          + '1. 准备 .txt / .pdf / .epub 格式的书籍<br>'
          + '2. 在 AI 面板点击「📤 上传文档」<br>'
          + '3. 系统自动索引，完成后即可提问书中内容<br><br>'
          + '<b>自定义知识库</b><br>'
          + '• 将 PDF/DOCX/TXT 放入 books/ 子目录<br>'
          + '• 运行 <code>node scripts/build-kb.js</code> 重新构建知识库分片' },
